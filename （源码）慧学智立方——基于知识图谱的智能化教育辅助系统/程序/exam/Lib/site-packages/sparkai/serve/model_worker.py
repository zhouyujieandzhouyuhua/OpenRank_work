...
from sparkai.constants import ErrorCode, SERVER_ERROR_MSG

from sparkai.serve.model.model_adapter import add_model_args
from sparkai.serve.base_model import BaseModelWorker, app
...
class ModelWorker(BaseModelWorker):
    def __init__(
        ...
        **kwargs,
        ...
        self.generate_stream_func = None#get_generate_stream_function(self.model, model_path)
